...
import { SchudeleTempleteComponent } from './schudele-templete/schudele-templete.component';

@Component({
  selector: 'app-user-schudeles',
  imports: [FormsModule, SchudeleTempleteComponent],
  templateUrl: './user-schudeles.component.html',
  styleUrl: './user-schudeles.component.css'
})
export class UserSchudelesComponent {
  selectDay: string = '';
  fromSelectHourMorning: string = '';
  toSelectHourMorning: string = '';
  fromSelectHourAfternoon: string = '';
  toSelectHourAfternoon: string = '';
  ...
  hoursAfternoon:string[] = ['12:00 m', '13:00 (1:00 p.m)', '14:00 (2:00 p.m)',
